...
## Using the plugin
Simply place the latest [compiled jar][Builds] in Spout's plugins folder and change the `config.yml` located under `plugins/DropletConfig`.
...
## The license
DropletConfig and all "Droplet" plugins for the Spout platform are licensed under the [MIT License][License].
...
[Source]: https://github.com/Droplets/DropletConfig
[Source Download]: https://github.com/Droplet/DropletConfig/archive/master.zip
[Builds]: http://build.spout.org/job/DropletConfig
